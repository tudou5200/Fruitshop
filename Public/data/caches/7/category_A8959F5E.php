<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:70:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/category.dwt";i:1;s:80:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/goods_list.lbi";i:2;s:81:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1479704243;s:8:"maketime";i:1479700643;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>进口水果_蔬菜水果_ 触屏版</title>
...
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=43&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list">销量 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb f-ico-triangle-slctd"></i> </span> </a> </li>
      <li class=""> <a href="category.php?category=43&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      <li class=""> <a href="category.php?category=43&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class="filter-cur"> <a href="category.php?category=43&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=43&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/ocailong_com/images/loader.gif" /></div>'})
	$(window).scroll(function () {
