<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:67:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/goods.dwt";i:1;s:78:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:81:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1479786771;s:8:"maketime";i:1479783171;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>澳洲进口牛尾巴300g 新鲜肥牛肉_精品肉类_生鲜食品_ 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/3_thumb_G_1448945490826.jpg"  alt="澳洲进口牛尾巴300g 新鲜肥牛肉" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://localhost/images/201512/goods_img/3_P_1448945490084.jpg"/></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://localhost/images/201512/goods_img/3_P_1448945490837.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect1" id="collect_box" href="javascript:collect(3)" style="display: inline;"></a>
  <div class="title">
    <h1> 澳洲进口牛尾巴300g 新鲜肥牛肉 </h1>
  </div>
    <div class="title">
    新鲜羊羔肉整只共15斤，原生态大山放牧羊羔，曾经的皇室贡品，央视推荐，2005年北京招待全球财金首脑。五层专用包装箱+真空包装+冰袋+保鲜箱+顺丰冷链发货，路途保质期8天 
  </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>255</span></b>　    <del>￥<span>306</span></del> 
    </li>
     
	    <li>	
	注册用户：<b class="price" >￥<span>255</span></b></li>
  </ul>
      <ul>
    <li>
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(3)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(3);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://localhost/images/201512/source_img/3_G_1448945490868.jpg"> </div>
            <div id="right">
              <p>澳洲进口牛尾巴300g 新鲜肥牛肉</p>
...
<img width="790" height="602" src="http://localhost/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:3;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1479783171,
    nonceStr: 'Y3sNjxWyYbavs8Cw',
    signature: '99f1deffd510bdf1a65bdb773045f731984dea3c',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '澳洲进口牛尾巴300g 新鲜肥牛肉',
      desc: '澳洲进口牛尾巴300g 新鲜肥牛肉',
      link: 'http://localhost/mobile/index.php?u=12',
      imgUrl: 'http://localhost/images/201512/source_img/3_G_1448945490868.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(3)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(3);">加入购物车</button>
