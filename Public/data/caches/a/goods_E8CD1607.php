<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:67:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/goods.dwt";i:1;s:78:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:81:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1479796763;s:8:"maketime";i:1479793163;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>法国百利威干红葡萄酒AOP级6支装_白酒_酒水饮料_ 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/18_thumb_G_1448947011803.jpg"  alt="法国百利威干红葡萄酒AOP级6支装" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://localhost/images/201512/goods_img/18_P_1448947011435.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(18)" style="display: inline;"></a>
  <div class="title">
    <h1> 法国百利威干红葡萄酒AOP级6支装 </h1>
  </div>
    <div class="title">
     
  </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>56</span></b>　    <del>￥<span>67</span></del> 
    </li>
     
	    <li>	
	注册用户：<b class="price" >￥<span>56</span></b></li>
  </ul>
      <ul>
    <li>
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(18)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(18);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://localhost/images/201512/source_img/18_G_1448947011231.jpg"> </div>
            <div id="right">
              <p>法国百利威干红葡萄酒AOP级6支装</p>
...
<img width="790" height="602" src="http://localhost/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:18;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1479793164,
    nonceStr: 'ldHSdVSR9xtA6Lj7',
    signature: 'bef8644b3b6c52c957ecebec78b3c2d4895a3f6b',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '法国百利威干红葡萄酒AOP级6支装',
      desc: '法国百利威干红葡萄酒AOP级6支装',
      link: 'http://localhost/mobile/index.php?u=12',
      imgUrl: 'http://localhost/images/201512/source_img/18_G_1448947011231.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(18)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(18);">加入购物车</button>
