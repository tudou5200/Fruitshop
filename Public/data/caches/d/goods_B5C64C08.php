<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:67:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/goods.dwt";i:1;s:78:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:81:"E:/5---RUANJIAN/wamp/www/apple/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1479796834;s:8:"maketime";i:1479793234;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>酣畅家庭菲力牛排10片澳洲生鲜牛肉团购套餐_叶菜类_生鲜食品_ 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/7_thumb_G_1448945104346.jpg"  alt="酣畅家庭菲力牛排10片澳洲生鲜牛肉团购套餐" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://localhost/images/201512/goods_img/7_P_1448945104734.jpg"/></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://localhost/images/201512/goods_img/7_P_1448945104883.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(7)" style="display: inline;"></a>
  <div class="title">
    <h1> 酣畅家庭菲力牛排10片澳洲生鲜牛肉团购套餐 </h1>
  </div>
    <div class="title">
     
  </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>238</span></b>　    <del>￥<span>286</span></del> 
    </li>
     
	    <li>	
	注册用户：<b class="price" >￥<span>238</span></b></li>
  </ul>
      <ul>
    <li>
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(7)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(7);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://localhost/images/201512/source_img/7_G_1448945104192.jpg"> </div>
            <div id="right">
              <p>酣畅家庭菲力牛排10片澳洲生鲜牛肉团购套餐</p>
...
<img width="790" height="602" src="http://localhost/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:7;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1479793234,
    nonceStr: 'Y127jZFZORS2fFO5',
    signature: '06413ef358423336e516a6a6996141fc70fd6332',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '酣畅家庭菲力牛排10片澳洲生鲜牛肉团购套餐',
      desc: '酣畅家庭菲力牛排10片澳洲生鲜牛肉团购套餐',
      link: 'http://localhost/mobile/index.php?u=12',
      imgUrl: 'http://localhost/images/201512/source_img/7_G_1448945104192.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(7)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(7);">加入购物车</button>
